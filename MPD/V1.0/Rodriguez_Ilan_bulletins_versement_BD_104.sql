...
-- Database: RODRIGUEZ_ILAN_BULLETINS_VERSEMENT_BD_104

-- Détection si une autre base de donnée du même nom existe

DROP DATABASE if exists RODRIGUEZ_ILAN_BULLETINS_VERSEMENT_BD_104;

-- Création d'un nouvelle base de donnée

CREATE DATABASE IF NOT EXISTS RODRIGUEZ_ILAN_BULLETINS_VERSEMENT_BD_104;

-- Utilisation de cette base de donnée

USE RODRIGUEZ_ILAN_BULLETINS_VERSEMENT_BD_104;
...
--
-- Client :  localhost
-- Généré le :  Lun 09 Mars 2020 à 07:05
...
CREATE TABLE `t_compte` (
  ...
  `compte_banque` varchar(63) NOT NULL,
...
INSERT INTO `t_personne` (`id_personne`, `nom_personne`, `prenom_personne`, `civilite_personne`) VALUES
(1, 'Culle', 'Jean', '');
...
--
ALTER TABLE `t_personne_compte`
  MODIFY `id_personne_compte` int(11) NOT NULL AUTO_INCREMENT;
--
